...
class VideoRequestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create video_request" do
    assert_difference('VideoRequest.count') do
      post video_requests_url, params: { video_request: { description: @video_request.description, slots: @video_request.slots, title: @video_request.title } }
    end
  ...
  test "should update video_request" do
    patch video_request_url(@video_request), params: { video_request: { description: @video_request.description, slots: @video_request.slots, title: @video_request.title } }
